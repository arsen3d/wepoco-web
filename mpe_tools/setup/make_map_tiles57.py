#!/bin/env python
# $Id: make_map_tiles.py 7 2006-12-30 20:10:37Z mike.saunby $
#
# Michael Saunby. For Wepoco.
#
# $Author: mike.saunby $
# $Date: 2006-12-30 20:10:37 +0000 (Sat, 30 Dec 2006) $


datadir='/home/mike/wepoco/data/mpe57/'
mapdir = datadir + "map/"
lutdir = datadir + "lut/"
...
def reproj_msat_lut(destdir, x, y, zoom):
    ...
    outwidth = tile_size
    outheight = tile_size
    met_fwd = metcoords.Meteosat(size=2500,generation=1,lon_0=57.0).fwd
    met_rows = 2500
    met_cols = 2500
...
def prepare_tiles( zoom, x_min, y_min, x_max, y_max ):
    ...
    for y in range(y_min,y_max):
        for x in range(x_min,x_max):
            ...
            reproj_msat_lut( lutdir, x, y, zoom )
            pass
        pass
    return
...
if __name__ == "__main__":
    ...
    prepare_tiles(zoom=2, x_min=2, y_min=1, x_max=4, y_max=3 )
#    prepare_tiles(zoom=3, x_min=5, y_min=2, x_max=7, y_max=5 )
#    prepare_tiles(zoom=4, x_min=10, y_min=4, x_max=14, y_max=9 )
#    prepare_tiles(zoom=5, x_min=20, y_min=8, x_max=28, y_max=17 )
