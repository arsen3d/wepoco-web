...
function setupNDVI()
{
    ...
    var rainlayer = new GTileLayer(new GCopyrightCollection("Meteorological data: Wepoco"),4,5);
    
    var ndvilayer = new GTileLayer(new GCopyrightCollection("Meteorological data: Wepoco"),4,5);
    ...
    rainlayer.getTileUrl = CustomGetRainTileUrl;
    rainlayer.isPng = function() {return 1;}
    rainlayer.getOpacity = function() {return 0.9;}
